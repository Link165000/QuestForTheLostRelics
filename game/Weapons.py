...
class Weapon():
    def __init__(self, damage_delt, exp_given, health_regen, spread):
...
class MeleeWeapon(Weapon):
    def __init__(self, damage_delt, exp_given, health_regen, spread):
        super().__init__(damage_delt, exp_given, health_regen, spread)
        
class RangedWeapon(Weapon):
    def __init__(self, damage_delt, range_of, exp_given, health_regen, spread):
        super().__init__(damage_delt, exp_given, health_regen, spread)
...
starter_sword = MeleeWeapon(damage_delt=1, exp_given=0.5, health_regen=0, spread=1)
starter_bow = RangedWeapon(damage_delt=1, range_of=2, exp_given=0.5, health_regen=0, spread=1)

intermediate_sword = MeleeWeapon(damage_delt=3, exp_given=2, health_regen=0, spread=1)
intermediate_bow = RangedWeapon(damage_delt=2, range_of=5, exp_given=1.5, health_regen=0, spread=1)
